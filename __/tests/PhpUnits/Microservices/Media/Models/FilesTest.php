<?php
	...
	class FilesTest extends TestCase {
		...
		public function testBuildFilesAllTypes(): void {
			$phpFiles = [
				'single_file_one_level' => [
					'name' => 'file1.txt',
					'type' => 'text/plain',
			...
			$expected = [
				new File('single_file_one_level', 'file1.txt', 'text/plain', '/tmp/phpD567.tmp', UPLOAD_ERR_OK, 1024),
				new File('[multiple_files_one_level][0]', 'file1.txt', 'text/plain', '/tmp/phpABC123', UPLOAD_ERR_OK, 1024),
				new File('[multiple_files_one_level][1]', 'file2.png', ImagesExtensions::PNG, '/tmp/phpDEF456', UPLOAD_ERR_OK, 2048),
				new File('[multiple_files_one_level][2]', 'file3.jpg', ImagesExtensions::JPG, '/tmp/phpGHI789', UPLOAD_ERR_OK, 3072)
			];

			$files_class = new Files($phpFiles);
			$files_class->buildFiles();
